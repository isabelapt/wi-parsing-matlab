function [time_arrival,powerpaths_dbm,powerphase_deg,rx_paths,path_max_rx ] =cir_insite(rx,paths_max,filename_cir)
rx_paths=[];
end_v =[];
...
A=str2double(A);
rx_paths(1)= A(2,1); % Number of paths of the first receiver
end_v(1) =rx_paths(1)*4+2; % Data from first receiver ends
