...
addpath('../Material_2/Teste4/results');
% addpath('..\Material_2\Teste4\results');
...
saveas(gcf,'capacitymimomodel_siso_nlos_wods.png');
savefig('capacitymimomodel_siso_nlos_wods.fig');
...
save('capacity_nlos_model.mat','Cequal','Csiso','MimoModel_rxW','Hnorm','Fnorm','Hm');
=======
% Script to simulate a narrowband geometric model
% clear,clc;
% close all;
